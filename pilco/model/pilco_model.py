    ...
    def optimize(self, restarts=1):
        ...
        for model, optimizer in zip(self.models, self.optimizers):
            ...
            best_params = {
                ...
                "k_variance": model.kernel.variance.numpy(),
                "l_variance": model.likelihood.variance.numpy()
            }
            ...
            for restart in range(restarts):
                ...
                if loss < best_loss:
                    ...
                    best_params["k_lengthscales"] = model.kernel.lengthscales.numpy()
                    best_params["k_variance"] = model.kernel.variance.numpy()
                    best_params["l_variance"] = model.likelihood.variance.numpy()
